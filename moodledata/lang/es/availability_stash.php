...
$string['description'] = 'Requiere un objeto en el inventario del usuario para acceder.';
...
$string['title'] = 'Objeto de inventario';
$string['unknowncondition'] = '[Condición desconocida]';
$string['unknownobject'] = '[Objeto desconocido]';
