...
$string['privacy:metadata:preference:tool_program_program_sort_filter'] = 'Almacena la selección del usuario para el filtro de ordenamiento de los programas';
...
$string['privacy:metadata:preference:tool_program_program_view_filter'] = 'Almacena la selección del usuario para el filtro de visualización del programa';
...
$string['programnamewithimageandlink'] = 'Nombre del programa con imagen y link';
$string['programnamewithlink'] = 'Nombre del programa con enlace';
...
$string['selectatleastoneprogram'] = 'Selecionar al menos un programa';
