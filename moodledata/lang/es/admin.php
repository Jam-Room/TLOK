...
$string['blockprotectblock'] = 'Proteger instancias del bloque {$a}';
$string['blockprotected'] = 'El bloque {$a} ahora está protegido';
$string['blocksettings'] = 'Gestionar bloques';
$string['blockunprotect'] = 'Desproteger';
$string['blockunprotectblock'] = 'Desproteger instancias del bloque {$a}';
$string['blockunprotected'] = 'El bloque {$a} ya no está protegido';
...
$string['configservicespage'] = 'Los usuarios llegarán a esta URL al clicar en "Servicios y soporte". Si el campo queda vacío el usuario será redirigido a la página oficial "Encuentre su socio de Moodle".';
...
$string['cron_keepalive_desc'] = 'El tiempo para mantener tareas adicionales en cola. Este ajuste es útil para asegurar que el cron siempre esté ejecutándose.<br><br>Si usa lanzadores de tareas dedicados, entonces debería ajustar este valor a 0. De lo contrario recomendamos ajustarlo a un valor similar al de su límite de concurrencia de tareas adhoc. Deben evitarse valores mayores y el valor máximo es 15 minutos.';
...
$string['disableplugin'] = 'Deshabilitar el plugin {$a}';
...
$string['enableplugin'] = 'Habilitar el plugin {$a}';
...
$string['plugin_disabled'] = 'El plugin {$a} se ha deshabilitado';
$string['plugin_enabled'] = 'El plugin {$a} se ha habilitado';
