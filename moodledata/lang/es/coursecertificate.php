...
$string['automaticsenddisabledinfo'] = 'Actualmente, {$a} estudiantes cumplen con las restricciones de acceso de esta actividad y se les emitirá su certificado una vez que accedan a ella.';
...
$string['enableautomaticsend'] = 'Todos los estudiantes recibirán automáticamente una copia en PDF del certificado tan pronto como cumplan con las restricciones de acceso de esta actividad.<br/><br/> Actualmente, {$a} estudiantes ya cumplen con estas restricciones de acceso pero aún no han accedido a esta actividad. También recibirán su copia de inmediato.<br/><br/> Los estudiantes que ya hayan accedido a esta actividad no recibirán el certificado nuevamente.';
